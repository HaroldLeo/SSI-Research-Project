...
data$grade <- (data$w1q63b + data$w1q63c + data$w1q63d + data$w1q63e + data$w1q63b) / 5
...
```{r}
mod = lm(grade ~ numsib + edulvl + numparents + schooltype + schoolqual + income, data = data)
mod1 = lm(atten ~ numsib + edulvl + numparents + schooltype + schoolqual + income, data = data)
mod2 = lm(grade ~ numsib + atten + edulvl + numparents + schooltype + schoolqual + income, data = data)
summary(mod)
summary(mod1)
summary(mod2)
```